...
def get_DTM_frame_data(bbox_manipulation=2, min_width=8, outlier_detection=False, x_shift=0, y_shift=0):
    ...
    dtm_germany_train.get_mini_frame_dataset(    kernel_size=64, 
                                            augmentation=True, 
    ...
    dtm_germany_test.get_mini_frame_dataset(     kernel_size=64, 
                                            augmentation=True, 
                                            augmentation_steps=2, 
                                            frame_steps=60, 
                                            bbox_manipulation=bbox_manipulation, 
    ...
    dtm_norway_train.get_mini_frame_dataset(     kernel_size=64, 
                                            augmentation=True, 
    ...
    dtm_norway_test.get_mini_frame_dataset(      kernel_size=64, 
                                            augmentation=True, 
                                            augmentation_steps=8, 
                                            frame_steps=60, 
                                            bbox_manipulation=bbox_manipulation, 
    ...
    dtm_norway_1.get_mini_frame_dataset(         kernel_size=64, 
                                            augmentation=True, 
                                            augmentation_steps=2, 
                                            frame_steps=60, 
                                            bbox_manipulation=bbox_manipulation, 
