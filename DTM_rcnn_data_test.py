...
def get_rcnn_data():
    ...
    frame_steps = 60
    dtm_germany_train.create_rcnn_dataset(  kernel_size=64, 
                                            augmentation=True, 
    ...
    dtm_germany_test.create_rcnn_dataset(   kernel_size=64, 
                                            augmentation=True,  
                                            augmentation_steps=augmentation_steps,   
                                            frame_steps=frame_steps * augmentation_steps, 
                                            data_type="test"   )   
    ...
    dtm_norway_train.create_rcnn_dataset(   kernel_size=64, 
                                            augmentation=True,   
                                            augmentation_steps=augmentation_steps,                                          
                                            frame_steps=frame_steps * augmentation_steps, 
                                            data_type="train"  )   
    ...
    dtm_norway_test.create_rcnn_dataset(    kernel_size=64, 
                                            augmentation=True, 
                                            augmentation_steps=augmentation_steps,                                             
                                            frame_steps=frame_steps * augmentation_steps, 
                                            data_type="test"   )   
